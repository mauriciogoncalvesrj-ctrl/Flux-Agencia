Ollama Cloud API at api.ollama.com: use /api/chat (Bearer auth). 39 models. OpenClaw v2026.5.7: @atlas_fluxia_bot ACTIVE. Primary: opencode-go. Meta Ad Library 100% blocked from VPS.
§
