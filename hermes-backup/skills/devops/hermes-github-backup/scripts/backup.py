...
Feito para rodar via cron diariamente à meia-noite (03:00 UTC = 00:00 BRT).
"""
...
def main():
    ...
    # Set remote URL with embedded token for push (bypasses credential store path issues in Docker)
