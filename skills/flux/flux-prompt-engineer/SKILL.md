...
1. **Contexto do cliente:** Leia `.agents/contexts/[cliente]/product-marketing-context.md` — paleta de cores, brand voice, tom, diferenciais visuais
2. **Ferramentas disponíveis:** Consulte `shared/TOOLS-REGISTRY.md` — Fal.ai MCP, image_generate, Puppeteer
3. **Regras de marca:** Consulte `shared/glossario.md` — texto em criativos NUNCA cita "GHL"
4. **Estado do Fal.ai:** Verificar se FAL_KEY tem saldo antes de qualquer geração
