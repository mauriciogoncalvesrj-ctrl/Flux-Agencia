...
**⚠️ Importante:** Trocar para modelo GLM-5.1 antes dos portões criativos (1-4) se disponível. Voltar para deepseek-v4-pro apenas na síntese final.
...
- ❌ **Usar modelo errado nos portões criativos** — se o Orquestrador está em deepseek-v4-pro, trocar para GLM-5.1 antes dos portões 1-4.
